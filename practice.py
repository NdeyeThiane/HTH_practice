...
my_reason_for_coding= 'I love nature'
...
#Type your code here.
global_mean_sea_level_2018= 2.21
...
global_mean_sea_level_delta_2018=type(21.36)
...
gift_list=['Cookies', 'Iphone', 'Laptop']
print(gift_list)

# Now let's create a dictionary with values in it.

grocery_list= {'Iphone': 8, 'Laptop': 'Mac', 'Cookies': 'Mint'}
print(grocery_list)
